...
class GatewayBoundaryTest {
  ...
  void configClassesMustBePackagePrivate() {
    classes()
        .that()
        .resideInAPackage("com.orasaka.gateway.infrastructure.config..")
        .and()
        .areNotInterfaces()
        .and()
  ...
  void gatewayDtoIsDomainBlind() {
    noClasses()
        .that()
        .resideInAPackage("com.orasaka.gateway.domain.model..")
        .should()
        .dependOnClassesThat()
  ...
  void gatewayEndpointsDoNotLeakEntities() {
    noClasses()
        ...
        .should()
        .dependOnClassesThat()
        .resideInAPackage("com.orasaka.identity.infrastructure.persistence.entity..")
        .because(
