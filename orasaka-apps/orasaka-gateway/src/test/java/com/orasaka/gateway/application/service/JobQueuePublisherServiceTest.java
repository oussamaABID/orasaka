...
class JobQueuePublisherServiceTest {
  ...
  @BeforeEach
  void setUp() {
    service = new JobQueuePublisherService(rabbitTemplate);
  }

  @Test
  void constructor_nullRabbitTemplate_throws() {
    assertThrows(NullPointerException.class, () -> new JobQueuePublisherService(null));
  }
  ...
  void publish_sendsMessageToRabbitTemplate() {
    ...
    verify(rabbitTemplate)
        .convertAndSend(RabbitMQConfig.EXCHANGE, RabbitMQConfig.ROUTING_KEY, message);
  }
