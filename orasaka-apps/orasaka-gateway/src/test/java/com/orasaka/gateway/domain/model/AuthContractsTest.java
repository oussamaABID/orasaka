...
class AuthContractsTest {
  ...
  void sonar_context_load() {
    assertNotNull(AuthContracts.class);
  }
  ...
  class LoginRequestTests {
    ...
    void nullEmail() {
      assertThrows(InvalidRequestException.class, () -> new AuthContracts.LoginRequest(null, PASS));
    }

    @Test
    @DisplayName("blank email throws InvalidRequestException")
    void blankEmail() {
      assertThrows(InvalidRequestException.class, () -> new AuthContracts.LoginRequest("  ", PASS));
    }
    ...
    void nullPassword() {
      assertThrows(
          InvalidRequestException.class, () -> new AuthContracts.LoginRequest(TEST_EMAIL, null));
    }
    ...
    void blankPassword() {
      assertThrows(
          InvalidRequestException.class, () -> new AuthContracts.LoginRequest(TEST_EMAIL, "  "));
    }
  }
  ...
  class AuthResponseTests {
    ...
    void nullInterceptions() {
      var resp = new AuthResponse("token", ADMIN, "admin@orasaka.com", List.of("ROLE_ADMIN"), null);
