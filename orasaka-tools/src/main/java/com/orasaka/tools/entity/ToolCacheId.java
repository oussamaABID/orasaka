...
/** Embeddable composite primary key class for {@link ToolCacheEntity}. */
@Embeddable
public class ToolCacheId implements Serializable {
   ...
   */
  public ToolCacheId(String toolId, String cacheKey) {
    this.toolId = toolId;
  ...
  public boolean equals(Object o) {
    ...
    ToolCacheId that = (ToolCacheId) o;
