...
public class OrasakaToolCacheEntity {

  @EmbeddedId private OrasakaToolCacheId id;
   ...
   */
  public OrasakaToolCacheId getId() {
    return id;
  }
   ...
   */
  public void setId(OrasakaToolCacheId id) {
    this.id = id;
  }
