/**
 * @file route.ts
 * @description NextAuth configuration and API handler route. Configures providers (OAuth and Credentials),
 * hooks up authorization logic to authenticate against the Orasaka Gateway user login endpoints,
 * maps active user profiles and session interceptions, and exposes JWT/Session callbacks for Next.js security.
 *
