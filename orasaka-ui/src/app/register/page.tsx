...
/** Feature bullet data for the marketing hero. */
const HERO_FEATURES = [
...
/**
 * RegisterPage — split layout with marketing hero (left) and registration form (right).
 * Matches the Login page's premium Calm Obsidian 2028 design.
 */
        ...
        <Card className="w-full max-w-md p-0">
          ...
          <CardContent className="space-y-4">
            ...
            {success && (
              <div
                role="status"
                className="rounded-lg bg-emerald-500/5 border border-emerald-500/10 px-3 py-2 text-sm text-emerald-600 dark:text-emerald-400"
              >
                {success}
              </div>
            )}
