...
import { Home, MessageSquare, LogOut, X } from "lucide-react";
 ...
 *
 * <p>Renders a static sidebar on desktop screen sizes and a toggleable slide-out drawer overlay
 * on mobile/touch interfaces. Pulls display configuration dynamically from {@link useTenant} (accent colors, scaling layouts)
 * and resolves translation dictionaries from {@link useTranslation}.
 * Runs as a Client Component ("use client").
 *
 * @returns A composite React element with static desktop and dynamic mobile sidebar layouts.
 * @see {@link useSidebar}
 * @see {@link useAuth}
 * @see {@link useTenant}
 */
