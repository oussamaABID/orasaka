              ...
              <li
                ...
                onKeyDown={(e) => {
                  if (e.key === "Enter" || e.key === " ")
                    onResumeSession(thread.conversationId);
                }}
                className="flex items-center justify-between py-3.5 px-3 rounded-[var(--radius-md)] cursor-pointer transition-all duration-200 hover:bg-[var(--surface-2)] hover:shadow-[var(--shadow-xs)] group"
              >
