...
/**
 * Representation of a dynamic layout field schema configuration.
 */
export interface SchemaField {
  /** Property identifier mapping key. */
  name: string;
  /** UI label displayed. */
  label: string;
  /** Field control input type choice. */
  type: "text" | "select" | "textarea";
  /** Flag representing if field validation demands non-empty responses. */
  required?: boolean;
  /** Dropdown options mapping if the type is set to select. */
  options?: SchemaFieldOption[];
  /** Optional fallback value for field. */
  defaultValue?: string;
