...
class IdentityServiceImplTest {
  ...
  void deleteUserCredential_delegatesToRepository() {
    ...
    verify(userCredentialRepository).deleteByUserIdAndProviderName(USER_ID.toString(), PROVIDER_OPENAI);
  }

  @Test
  void getDecryptedApiKey_delegatesToRepository() {
    when(userCredentialRepository.findApiKeyByUserIdAndProviderName(USER_ID.toString(), PROVIDER_OPENAI))
