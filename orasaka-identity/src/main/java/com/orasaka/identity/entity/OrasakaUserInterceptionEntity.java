...
public class OrasakaUserInterceptionEntity {

  @EmbeddedId private OrasakaUserInterceptionId id;
  ...
  public OrasakaUserInterceptionEntity() {}
   ...
   */
  public OrasakaUserInterceptionId getId() {
    return id;
  }
   ...
   */
  public void setId(OrasakaUserInterceptionId id) {
    this.id = id;
  }
