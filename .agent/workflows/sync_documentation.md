...
- Environment variables changes (`.env`, `orasaka-apps/orasaka-ui/.env.local`)
...
- **docs/END2END_TEST.md**: Playwright E2E framework.
...
- **IaC**: Changes to `ops/deploy/terraform/**` must update `docs/DEPLOY.md`.
