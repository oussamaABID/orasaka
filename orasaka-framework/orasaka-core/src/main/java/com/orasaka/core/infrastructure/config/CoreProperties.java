...
public record CoreProperties(
  ...
  public record OrchestrationConfig(
    ...
    /** Convenience constructor without routing — defaults to DETERMINISTIC fallback. */
    public OrchestrationConfig(
        ...
        InterceptorConfig refiner,
        InterceptorConfig router) {
      this(enabled, userContext, systemContext, refiner, router, new RoutingConfig(null, null));
    }
  }
