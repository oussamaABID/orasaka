...
public class MemoryResolver {
   ...
   * InMemoryChatMemory} is returned — suitable for one-off stateless calls. Otherwise, the memory
   * is persisted in the internal map for the lifetime of this bean.
   *
