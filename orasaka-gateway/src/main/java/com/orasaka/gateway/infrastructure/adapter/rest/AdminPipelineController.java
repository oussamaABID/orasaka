...
public class AdminPipelineController {
  ...
  public AdminPipelineController(
      PipelineConfigProvider configProvider, OrchestrationPipeline pipeline) {
    this.configProvider =
        Objects.requireNonNull(configProvider, "PipelineConfigProvider must not be null");
    this.pipeline = Objects.requireNonNull(pipeline, "OrchestrationPipeline must not be null");
  }
