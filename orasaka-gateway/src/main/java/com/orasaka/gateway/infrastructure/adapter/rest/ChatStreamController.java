      ...
      stream.subscribe(
          ...
          error -> {
            ...
            try {
              ...
              // Ignore exception on completeWithError because client might have already disconnected
            }
          },
          () -> {
            ...
            try {
              ...
              // Ignore exception on complete because client might have already disconnected
            }
          });
    } catch (Exception e) {
      logger.error(
