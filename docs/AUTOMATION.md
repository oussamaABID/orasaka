...
- **Connector Dispatcher**: Outbound actions (Jira, Slack, Messenger, WhatsApp) are implemented as log-stubs in [ConnectorDispatcher.java](file:///Users/oussamaabid/Documents/projects/orasaka/orasaka-workers/external-services/src/main/java/com/orasaka/workers/integration/service/ConnectorDispatcher.java).
