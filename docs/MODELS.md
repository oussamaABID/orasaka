...
| Model Name | Model Label | Category | Default Voices |
| :--- | :--- | :--- | :--- |
...
| Model Name | Model Label | Category | Purpose |
| :--- | :--- | :--- | :--- |
| `sdxl-turbo-gguf` | SDXL Turbo (GGUF) | Image | Fast execution on CPU/Metal |
| `sd-1.5-apple-coreml` | SD 1.5 (Apple CoreML) | Image | Apple Silicon optimized CoreML |
| `stable-diffusion-xl` | Stable Diffusion XL | Image | High-fidelity SDXL renders (default) |
| `v1-5-pruned-emaonly` | SD 1.5 Pruned EMA (safetensors) | Image | Apple Silicon MLX optimized |
...
| Model Name | Model Label | Category | Platform Engine |
| :--- | :--- | :--- | :--- |
| `stable-video-diffusion-img2vid-xt` | Stable Video Diffusion XT | Video | SVD img2vid on Metal/MPS (default) |
| `animatediff-lightning-mps` | AnimateDiff Lightning (MPS) | Video | Fast AnimateDiff rendering |
| `apple-coreml-video-pipeline` | Apple CoreML Video Pipeline | Video | MPS CoreML native pipeline |
| `stable-video-diffusion-img2vid-xt-mps-fp32` | SVD XT (PyTorch MPS Float32) | Video | Apple Silicon MLX float32 |
...
| Model Name | Model Label | Category | Platform |
| :--- | :--- | :--- | :--- |
| `llama3.2-vision:latest` | Llama 3.2 Vision (latest) | Vision | Ollama host vision (default) |
| `llava:latest` | LLaVA (latest) | Vision | Multimodal fallback |
| `llava:v1.6` | LLaVA (v1.6) | Vision | LLaVA version 1.6 |
| `bakllava:latest` | BakLLaVA (latest) | Vision | BakLLaVA multimodal |
...
| Model Name | Model Label | Category | Platform |
| :--- | :--- | :--- | :--- |
| `whisper-base` | Whisper Base | Audio | Ollama (default) |
| `whisper-tiny-en` | Whisper Tiny (en) | Audio | Ollama lightweight |
...
| Model Name | Model Label | Category | Quantization |
| :--- | :--- | :--- | :--- |
| `qwen2.5-coder:7b` | Qwen 2.5 Coder 7B | Code | `q4_K_M` (default) |
| `codellama:7b` | CodeLlama 7B | Code | `q4_K_M` |

---

## 7. MLX Native Models (Apple Silicon Unified Memory)

Models optimized for Apple Silicon MLX framework (unified memory architecture).

| Model Name | Model Label | Category | Hardware |
| :--- | :--- | :--- | :--- |
| `argmaxinc/mlx-FLUX.1-schnell-4bit-quantized` | FLUX.1 Schnell 4-bit (MLX) | Image | Apple Silicon MLX |
| `ByteDance/AnimateDiff-Lightning` | AnimateDiff Lightning | Video | Apple Silicon MLX |
| `mlx-animatediff-lightning` | MLX Native AnimateDiff | Video | Apple Silicon MLX |
| `mlx-stable-diffusion-video` | MLX Native Video | Video | Apple Silicon MLX |
