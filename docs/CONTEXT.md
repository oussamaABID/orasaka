...
- **ADR-040**: Hermetic E2E testing via `orasaka-end2end` module. 3-Tier test pyramid (httpyac API → CLI Vitest → Playwright Java UI). Configurable 4-Tier Validation Matrix: JSON Schema -> MCP Sandbox -> Multi-Agent Debate -> Test-Driven Response.
