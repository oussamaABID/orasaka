 ...
 *
 * <p>Extracted to eliminate Sonar S1192 (duplicate string literals) violations across the
 * monorepo. Each constant is documented with the approximate cross-module usage count.
 *
