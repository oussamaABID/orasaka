...
class ContextTest {
  ...
  class Defaults {
    ...
    void nullPrefsDefault() {
      var ctx = new Context(USER_1, "conv1", null, null);
  ...
  class AuthorityChecks {
    ...
    void hasAuthority() {
      var ctx = new Context(USER_1, "conv1", Map.of(), Set.of(new Authority("ADMIN")));
    ...
    void hasAuthorityFalse() {
      var ctx = new Context(USER_1, "conv1", Map.of(), Set.of());
  ...
  class Immutability {
    ...
    void preferencesImmutable() {
      ...
      assertThrows(UnsupportedOperationException.class, () -> prefs.put("x", "y"));
    }
  }
}
