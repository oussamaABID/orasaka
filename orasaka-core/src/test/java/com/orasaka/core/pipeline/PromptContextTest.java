...
class PromptContextTest {
  ...
  class CompactConstructor {
    ...
    void nullUserMetadataDefaultsEmpty() {
      var ctx = new PromptContext("query", null, null, "query", null);
    ...
    void nullSystemMetadataDefaultsEmpty() {
      var ctx = new PromptContext("query", Map.of(), null, "query", null);
    ...
    void filtersNullKeys() {
      ...
      meta.put(null, "value");
      meta.put("key", "valid");
      var ctx = new PromptContext("query", meta, Map.of(), "query", null);
    ...
    void defensiveCopy() {
      ...
      input.put("key", "value");
      var ctx = new PromptContext("query", input, Map.of(), "query", null);
